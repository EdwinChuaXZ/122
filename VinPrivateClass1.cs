...
{
    internal class VinPrivateClass1
    {
        ...
        // full consturt
        public VinPrivateClass1(Arrowhead aarrowhead, Fletch afletch, double alength)
        {
        ...
        // empty consturt
        public VinPrivateClass1() : this(Arrowhead.steel, Fletch.plastic, -1.0)
        {
